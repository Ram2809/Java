...
public class ArrayOfObjects {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		//obj[0].id=1;//you can't assign like this it throws an null pointer exception ,first u need to assign objects for array of objects
		for(int i=0;i<obj.length;i++)
		{
			obj[i]=new Student();//after this step u can proceed with logic
		}
