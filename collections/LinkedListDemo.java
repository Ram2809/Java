...
class Student1 implements Comparable//interface(used for list and we order only one member)
{
	Integer id;
	String name;
...
public class LinkedListDemo {
	public static void main(String[] args)
	{
		...
		List l=new LinkedList();//creation of arraylist, here list is the interface and ArrayList is the subclass of List Interface
		...
		System.out.println("--------------------------");
		System.out.println("Changing the elements of linked list:");
		System.out.println("Before updating the linked list elements:");
		System.out.println(l);
		l.set(2,"Java");//changing the value
		l.set(4, 1000);
		System.out.println("After updating the linked list elements:");
		System.out.println(l);
		System.out.println("--------------------------");
		System.out.println("Removing the elements of linked list:");
		System.out.println("Before removing the linked list elements:");
		System.out.println(l);
		l.remove(1);//removing the element from the list
		l.remove("Java");
		System.out.println("After removing the linked list elements:");
		System.out.println(l);
		System.out.println("--------------------------");
		System.out.println("Iterating the linked list using iterator:");
		...
		System.out.println();
		System.out.println("--------------------------");
		System.out.println("Iterating the linked list using for each:");
		System.out.println("The linked list elements are:");
		for(Object e: l)
		{
			System.out.print(e+" ");
		...
		System.out.println("Elements of 1st linked list:");
		...
		System.out.println("Elements of 2nd linked list:");
		...
		//custom Inputs
		LinkedList<Student> sList=new LinkedList<Student>();//Creating Custom inputs(using objects not primitives)
		...
		System.out.println(al);
		LinkedList<Integer> alCopy=new LinkedList<Integer>(al);
